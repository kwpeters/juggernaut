...
class CaptLogLauncher(object):
    ...
    def __AppendDailyTemplate(self, logFile):
        ...
        timeTemplate = r'''    |---+-----+-------------------------------------------------------------|
    |   |     | TeamONE 5.0      (SAP ActType CPA003 = SW DES ENG 5364.2.1) |
    |---+-----+-------------------------------------------------------------|
    |   |     | TeamONE 5.0 - overtime        (SAP ActType CCC902 5364.2.1) |
    |---+-----+-------------------------------------------------------------|
    |   |     | TeamONE 5.0      (SAP ActType CPA003 = SW DES ENG 6105.2.1) |
    |   |     | (starting Oct. 23)                                          |
    |---+-----+-------------------------------------------------------------|
    |   |     | Info Gateway                                   (SAP 5925.1) |
    |---+-----+-------------------------------------------------------------|
